...
export type WorkspaceMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role" | "createdAt" | "updatedAt" | "workspaceId" | "userId", ExtArgs["result"]["workspaceMember"]>
...
export interface WorkspaceMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const workspaceMemberWithCreatedAtOnly = await prisma.workspaceMember.findMany({ select: { createdAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many WorkspaceMembers and only return the `createdAt`
   * const workspaceMemberWithCreatedAtOnly = await prisma.workspaceMember.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more WorkspaceMembers and only return the `createdAt`
   * const workspaceMemberWithCreatedAtOnly = await prisma.workspaceMember.updateManyAndReturn({
   *   select: { createdAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
